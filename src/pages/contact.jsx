  ...
  const resume = {
    ...
    experience: [
      ...
      },
      {
        ...
        logo: 'https://logo.clearbit.com/intelimetrica.com',
        ...
        <Col xs={11} md={8} lg={6}>
          <ResumeCard shadow>
            ...
            <Section>
              ...
              <Text small style={{ marginBottom: '4px' }}>
                Email:{' '}
                ...
                >
                  <Row>
                    <Col xs={2} style={{ textAlign: 'center' }}>
                      {exp.logo && <Avatar src={exp.logo} size="32px" />}
                    </Col>
                    <Col xs={10}>
                      <Text h5>
                        {exp.role} -{' '}
                        <Link href={exp.link} pure underline>
                          {exp.company}
                        </Link>
                      </Text>
